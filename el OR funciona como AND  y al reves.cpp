...
#include<conio.h>
#include<time.h>
int num[6],cal[11],res1[11],i,j,numram,op,eleccion,op2,rest,puntaje,puntaje2,nori[11],ope[4],puntos,puntos2,turnos;
main()
{	
	numram=1;
	...
	//Por alguna razon desconocida esto funciona como OR y || este como  AND.
